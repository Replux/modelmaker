...
@SupportedAnnotationTypes(ANNOTATION_BUILDER)
@SupportedSourceVersion(SourceVersion.RELEASE_8)
public class BuilderProcessor extends BaseProcessor {

    private Name className; // 类名
    private Name builderClassName; // Builder模式中的类名，例如原始类是User，那么建造者类名就是UserBuilder
    private List<JCTree.JCVariableDecl> fieldJCVariables; // 字段的语法树节点的集合
